...
\begin{sidewaysfigure}
  \subfloat[First caption\label{fig:fp1}]{\includegraphics[width=.8\textheight]{nuaa.pdf}} \\
  \subfloat[Second caption]{\includegraphics[height=2cm]{nuaa.pdf}}
  \caption{一幅占用完整页面的图片}
  \label{fig:fullpage1}
\end{sidewaysfigure}
...
\setcounter{subfigure}{0}
\begin{sidewaysfigure}
  \subfloat[First caption]{\includegraphics[height=2cm]{nuaa.pdf}} \\
  \subfloat[Second caption]{\includegraphics[width=.8\textheight]{nuaa.pdf}}
